...
namespace Identity.System.Implementation
{
    public class DatabaseUserStore<TUser, TRole, TUserRole, TUserClaim, TKey, TContext> : DatabaseStore<TContext>,
        ...
        where TUser : IdentitySystemUser<TKey>, new()
        where TRole : IdentitySystemRole<TKey>, new()
        where TUserRole : IdentitySystemUserRole<TKey>, new()
        where TUserClaim: IdentitySystemUserClaim<TKey>, new()
    {
